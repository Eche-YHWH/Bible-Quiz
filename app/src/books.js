...
export const BOOK_DIRECTORY = {
  genesis: { title: "Genesis" },
  exodus: { title: "Exodus" },
  leviticus: { title: "Leviticus" },
  numbers: { title: "Numbers" },
  deuteronomy: { title: "Deuteronomy" },
  joshua: { title: "Joshua" },
  judges: { title: "Judges" },
  ruth: { title: "Ruth" },
  "1samuel": { title: "1 Samuel" },
  "2samuel": { title: "2 Samuel" },
  "1kings": { title: "1 Kings" },
  "2kings": { title: "2 Kings" },
  "1chronicles": { title: "1 Chronicles" },
  "2chronicles": { title: "2 Chronicles" },
  ezra: { title: "Ezra" },
  nehemiah: { title: "Nehemiah" },
  esther: { title: "Esther" },
  job: { title: "Job" },
  psalms: { title: "Psalms" },
  proverbs: { title: "Proverbs" },
  ecclesiastes: { title: "Ecclesiastes" },
  songofsolomon: { title: "Song of Solomon" },
  isaiah: { title: "Isaiah" },
  jeremiah: { title: "Jeremiah" },
  lamentations: { title: "Lamentations" },
  ezekiel: { title: "Ezekiel" },
  daniel: { title: "Daniel" },
  hosea: { title: "Hosea" },
  joel: { title: "Joel" },
  amos: { title: "Amos" },
  obadiah: { title: "Obadiah" },
  jonah: { title: "Jonah" },
  micah: { title: "Micah" },
  nahum: { title: "Nahum" },
  habakkuk: { title: "Habakkuk" },
  zephaniah: { title: "Zephaniah" },
  haggai: { title: "Haggai" },
  zechariah: { title: "Zechariah" },
  malachi: { title: "Malachi" },
  matthew: { title: "Matthew" },
  mark: { title: "Mark" },
  luke: { title: "Luke" },
  john: { title: "John" },
  acts: { title: "Acts" },
  romans: { title: "Romans" },
  "1corinthians": { title: "1 Corinthians" },
  "2corinthians": { title: "2 Corinthians" },
  galatians: { title: "Galatians" },
  ephesians: { title: "Ephesians" },
  philippians: { title: "Philippians" },
  colossians: { title: "Colossians" },
  "1thessalonians": { title: "1 Thessalonians" },
  "2thessalonians": { title: "2 Thessalonians" },
  "1timothy": { title: "1 Timothy" },
  "2timothy": { title: "2 Timothy" },
  titus: { title: "Titus" },
  philemon: { title: "Philemon" },
  hebrews: { title: "Hebrews" },
  james: { title: "James" },
  "1peter": { title: "1 Peter" },
  "2peter": { title: "2 Peter" },
  "1john": { title: "1 John" },
  "2john": { title: "2 John" },
  "3john": { title: "3 John" },
  jude: { title: "Jude" },
  revelation: { title: "Revelation" },
};
...
export const MAP_GROUPS = [
  {
    ...
    focus: { x: 50, y: 14, scale: 2.1 },
    spot: { left: 18, top: 6, width: 68, height: 12 },
    books: ["genesis", "exodus", "leviticus", "numbers", "deuteronomy"],
  },
  {
    id: "historical",
    title: "Historical Books",
    focus: { x: 30, y: 28, scale: 1.9 },
    spot: { left: 4, top: 18, width: 62, height: 20 },
    books: [
      "joshua",
      "judges",
      "ruth",
  ...
  },
  {
    id: "wisdom",
    title: "Wisdom Poetry",
    focus: { x: 79, y: 31, scale: 2.25 },
    spot: { left: 67, top: 19, width: 24, height: 18 },
    books: ["job", "psalms", "proverbs", "ecclesiastes", "songofsolomon"],
  },
  {
    id: "major-prophets",
    title: "Major Prophets",
    focus: { x: 26, y: 44, scale: 2.05 },
    spot: { left: 4, top: 38, width: 44, height: 16 },
    books: ["isaiah", "jeremiah", "lamentations", "ezekiel", "daniel"],
  },
  {
    id: "minor-prophets",
    title: "Minor Prophets",
    focus: { x: 74, y: 48, scale: 2.05 },
    spot: { left: 55, top: 40, width: 37, height: 17 },
    books: [
      "hosea",
      "joel",
      "amos",
  ...
  },
  {
    id: "gospels",
    title: "The Gospels",
    focus: { x: 31, y: 61, scale: 2.2 },
    spot: { left: 7, top: 56, width: 46, height: 10 },
    books: ["matthew", "mark", "luke", "john"],
  },
  {
    id: "church-history",
    title: "Church History",
    focus: { x: 78, y: 60.5, scale: 2.7 },
    spot: { left: 66, top: 55, width: 19, height: 11 },
    books: ["acts"],
  },
  {
    id: "pauls-letters",
    title: "Paul's Letters",
    focus: { x: 50, y: 76, scale: 1.75 },
    spot: { left: 6, top: 67, width: 82, height: 18 },
    books: [
      "romans",
      "1corinthians",
      "2corinthians",
  ...
  },
  {
    ...
    focus: { x: 26, y: 91, scale: 2.15 },
    spot: { left: 7, top: 84.5, width: 41, height: 13 },
    books: ["hebrews", "james", "1peter", "2peter", "1john", "2john", "3john", "jude"],
  },
  {
    id: "prophecy",
    title: "Prophecy",
    focus: { x: 75, y: 91.5, scale: 2.35 },
    spot: { left: 58, top: 85, width: 28, height: 13 },
    books: ["revelation"],
  },
];
